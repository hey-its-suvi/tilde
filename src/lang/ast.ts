 ...
 *  Values may be scalar refs resolved during elaboration; nested tuples are
 *  allowed so a circle can be written ((cx, cy), r). The optional hint keyword
 *  (point/line/circle) disambiguates when the tuple length is ambiguous for
 *  the context. */
