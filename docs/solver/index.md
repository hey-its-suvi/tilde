...
flowchart TD
    ...
    Choose the first unconstrained free vertex.
    Fix it at (0, 0) as the coordinate origin."]
...
- [Pass 2 — Anchor](./anchor) — why geometry needs a fixed point, and how one is chosen
- [Pass 3 — Placement](./placement) — the core fixpoint loop that places every vertex
